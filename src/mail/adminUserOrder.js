...
const formatMessage = (order, name, address) => {
  let totalPrice = 0;
  let html = `
<html lang="en">
  <head>
  ...
  <body>
    <div class="container-fluid">
      <h3>${name} Purchase Information</h3>
...
const adminUserOrderSummary = (order, name, address) => {
...
module.exports = adminUserOrderSummary;
